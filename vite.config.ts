...
export default defineConfig({
  plugins: [
    ...
    VueRouter({
      ...
      extendRoute(route) {
        ...
        // Mutate route langsung, jangan return
        // if (!route.meta.action)
        //   route.meta.action = route.name === 'beranda' ? 'read' : undefined
        // if (!route.meta.subject)
        //   route.meta.subject = 'Admin'
  ...
  server: {
    port: 3000,
    host: true, // biar bisa diakses lewat IP lokal juga
  },
})
